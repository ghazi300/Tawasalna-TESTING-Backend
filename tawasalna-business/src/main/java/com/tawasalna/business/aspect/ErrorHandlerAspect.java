package com.tawasalna.business.aspect;
...
public class ErrorHandlerAspect {
    ...
    @AfterThrowing(value = "execution(public * com.tawasalna.business.service.*.*.*(..))", throwing = "ex")
    ...
    @Around("execution(public * com.tawasalna.business.controllers.*.*(..)))")
