package com.tawasalna.tawasalnacrm.aspects;
...
public class ErrorHandlerAspect {
    ...
    @AfterThrowing(value = "execution(public * com.tawasalna.tawasalnacrm.service.*.*.*(..))", throwing = "ex")
    ...
    @Around("execution(public * com.tawasalna.tawasalnacrm.controller.*.*(..)))")
