package com.tawasalna.social.aspects;
...
public class ErrorHandlerAspect {
    ...
    @AfterThrowing(value = "execution(public * com.tawasalna.social.service.*.*.*(..))", throwing = "ex")
    ...
    @Around("execution(public * com.tawasalna.social.payload.request.controller.*.*(..)))")
